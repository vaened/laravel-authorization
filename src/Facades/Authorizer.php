...
/**
 * @method static bool can(Subject|Role $owner, array $permissions, Junction $junction = Junction::Or)
 * @method static bool cannot(Subject|Role $owner, array $permissions, Junction $junction = Junction::Or)
